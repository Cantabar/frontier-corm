...
- Forge Planner: ore optimization could consider alternative refining recipes when multiple recipes produce the same intermediate from different ores
