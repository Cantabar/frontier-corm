...
PACKAGES=("tribe" "forge_planner" "trustless_contracts")
ENV_VARS=("PACKAGE_TRIBE" "PACKAGE_FORGE_PLANNER" "PACKAGE_TRUSTLESS_CONTRACTS")
VITE_VARS=("VITE_TRIBE_PACKAGE_ID" "VITE_FORGE_PLANNER_PACKAGE_ID" "VITE_TRUSTLESS_CONTRACTS_PACKAGE_ID")
