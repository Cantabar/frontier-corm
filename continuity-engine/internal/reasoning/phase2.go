...
func handlePhase2Effects(ctx context.Context, h *Handler, environment, cormID string, traits *types.CormTraits, evt types.CormEvent) {
	...
	default:
		...
		if h.registry != nil && h.chainClient != nil {
			attemptContractGeneration(ctx, h, environment, cormID, traits, evt)
		}
	}
}
...
func attemptContractGeneration(ctx context.Context, h *Handler, environment, cormID string, traits *types.CormTraits, evt types.CormEvent) {
	...
	// Step 6: Notify player session with generic narrative
