...
type ContractIntent struct {
	ContractType string `json:"contract_type"` // "coin_for_item", "item_for_coin", "item_for_item", "corm_giveaway"
...
const (
	...
	ContractCORMGiveaway = "corm_giveaway"
)
